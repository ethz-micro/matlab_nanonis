...
%% load SEM data
%imag name
fn='Data/2015-03-04/image006.sxm'; % 5-7
%Load 2,4,6,8 (forward channel 0 1 2 3)
file6=loadSxM.loadProcessedSxM(fn,2:2:8);
%Add datas
...
file4 = loadSxM.loadProcessedSxM(fn,0);

%{
fn='Data/2013-03-01/m2_ori.par';
file4=loadSxM.loadProcessedPar(fn);

fn='Data/2013-03-01/m19_ori.par';
file6=loadSxM.loadProcessedPar(fn);
...
%Plot bare data 
figure
plotSxM.plotChannel(channel,file6.header);
